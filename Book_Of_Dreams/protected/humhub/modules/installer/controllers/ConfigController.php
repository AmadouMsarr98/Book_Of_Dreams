...
class ConfigController extends Controller
{
    ...
    public function actionAdmin()
    {
        ...
        if ($form->submitted('save') && $form->validate()) {
            ...
            // Create Mur d'Idees Space
            $space = new Space();
            $space->name = Yii::t("InstallerModule.controllers_ConfigController", "Mur d'idées");
            $space->description = Yii::t("InstallerModule.controllers_ConfigController", "Votre espace pour participer à l'innovation de la Sonatel.");
            ...
            // Create Ilab Space
            $space = new Space();
            $space->name = Yii::t("InstallerModule.controllers_ConfigController", "Ilab");
            $space->description = Yii::t("InstallerModule.controllers_ConfigController", "");
            $space->join_policy = Space::JOIN_POLICY_FREE;
            $space->visibility = Space::VISIBILITY_ALL;
            $space->created_by = $adminUser->id;
            $space->auto_add_new_members = 1;
