...
return array (
  ...
  '<strong>Create</strong> task list' => 'Görev listesi oluştur',
  '<strong>Edit</strong> task list' => 'Görev listesini düzenle',
  '<strong>Task</strong> Overview' => '',
  'Accept Task' => 'Görevi kabul et',
  'Add Task List' => 'Görev Listesi Ekle',
  'Add task' => 'Görev ekle',
