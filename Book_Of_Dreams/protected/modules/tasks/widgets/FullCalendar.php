...
class FullCalendar extends JsWidget
{
    ...
    public function init()
    {
        ...
        if($this->contentContainer) {
            $this->editUrl = $this->contentContainer->createUrl('/tasks/task/edit', ['cal' => true]);
            $this->dropUrl = $this->contentContainer->createUrl('/tasks/task/edit');
        }
    ...
    public function getData()
    {
        return [
            ...
            'global-create-url' => Url::to(['/tasks/calendar/select']),
